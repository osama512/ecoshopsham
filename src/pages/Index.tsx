    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="px-4 py-16 md:py-24 text-center max-w-3xl mx-auto">
        ...
        <p className="text-muted-foreground mt-4 text-base md:text-lg max-w-xl mx-auto">
          منصة SyriaBiz تساعدك على إنشاء متجر إلكتروني احترافي، استقبال الطلبات عبر واتساب، وإدارة مبيعاتك بسهولة.
        </p>
      ...
      <section className="px-4 py-12 max-w-4xl mx-auto">
        <h3 className="text-2xl font-display font-bold text-center mb-8">لماذا SyriaBiz؟</h3>
      ...
      <section className="px-4 py-16 text-center">
        <Card className="max-w-lg mx-auto p-8 bg-primary text-primary-foreground space-y-4">
          ...
          <p className="text-sm opacity-80">انضم لمئات التجار السوريين الذين يثقون بـ SyriaBiz</p>
          <Link to="/signup">
      ...
      <footer className="text-center py-6 text-xs text-muted-foreground border-t">
        © {new Date().getFullYear()} SyriaBiz — جميع الحقوق محفوظة
      </footer>
    </div>
  );
};
